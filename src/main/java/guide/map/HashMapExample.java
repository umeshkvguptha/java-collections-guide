...
public class HashMapExample {
    ...
    public static void main(String[] args) {
        // Create a HashMap to store Employee objects, using Employee name as the key.
        // Internally, HashMap uses a hash table to store the keys and values.
        // The time complexity for adding, searching, and removing elements is O(1) on average.
        Map<String, Employee> employeeMap = new HashMap<>(SIZE);
    ...
    /**
     * Adds Employee objects to the HashMap.
    ...
    /**
     * Displays all employees in the HashMap.
    ...
    /**
     * Searches for an employee by name in the HashMap.
     * Time Complexity: O(1) - HashMap provides average constant time lookup.
     * Space Complexity: O(1) - No additional data structures are used.
     */
    ...
    /**
     * Removes an employee from the HashMap by name.
     * Time Complexity: O(1) - HashMap provides average constant time removal.
     * Space Complexity: O(1) - No additional data structures are used.
     */
